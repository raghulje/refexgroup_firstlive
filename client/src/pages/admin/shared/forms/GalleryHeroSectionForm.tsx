...
interface GalleryHeroSectionFormProps {
  formData: any;
...
export const GalleryHeroSectionForm = ({
  formData,
  handleInputChange,
  uploadImage,
  uploadingImage,
    ...
    <div className="space-y-4">
      ...
      <div className="border-t pt-4 mt-4">
        ...
        <FormField
          ...
          name="overlayOpacity"
          type="number"
          value={formData.overlayOpacity !== undefined ? formData.overlayOpacity : 40}
          onChange={(value) => handleInputChange('overlayOpacity', value)}
          error={errors.overlayOpacity}
          helpText="Opacity of the dark overlay on the background image (0-100). Default: 40"
          min={0}
          max={100}
        />
