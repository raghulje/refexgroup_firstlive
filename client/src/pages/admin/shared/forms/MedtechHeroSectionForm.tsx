...
interface MedtechHeroSectionFormProps {
  formData: any;
...
export const MedtechHeroSectionForm = ({
  formData,
  handleInputChange,
  uploadImage,
  uploadingImage,
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        <FormField
          label="Button Text"
          name="buttonText"
          value={formData.buttonText || 'Explore'}
        ...
        <FormField
          label="Button Link"
          name="buttonLink"
          value={formData.buttonLink || '#explore'}
