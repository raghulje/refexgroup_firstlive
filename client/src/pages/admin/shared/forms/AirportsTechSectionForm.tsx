...
interface AirportsTechSectionFormProps {
  formData: any;
...
export const AirportsTechSectionForm = ({
  formData,
  handleInputChange,
  uploadImage,
  uploadingImage,
  errors = {}
}: AirportsTechSectionFormProps) => {
    ...
    <div className="space-y-4">
      ...
      <div className="border-2 border-gray-200 rounded-lg p-4 bg-gray-50">
        <div className="flex justify-between items-center mb-4">
          <h4 className="font-semibold text-gray-900">Tech Highlight Cards</h4>
          <button
            type="button"
            onClick={addCard}
        ...
        <div className="space-y-3">
          {cards.length > 0 ? (
            ...
            <p className="text-gray-400 text-sm italic">
              No cards added yet. Click "Add Card" to add tech highlights.
            </p>
          )}
        </div>
      </div>
