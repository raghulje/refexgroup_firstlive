...
interface CapitalHeroSectionFormProps {
  formData: any;
...
export const CapitalHeroSectionForm = ({
  formData,
  handleInputChange,
  uploadImage,
  uploadingImage,
  ...
  return (
    <div className="space-y-4">
      ...
      <FormField
        ...
        error={errors.badge}
        helpText="Small label text above the title (e.g. 'WE ADD')"
      />
