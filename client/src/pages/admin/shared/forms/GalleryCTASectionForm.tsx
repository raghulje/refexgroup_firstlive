...
interface GalleryCTASectionFormProps {
  formData: any;
  handleInputChange: (key: string, value: any) => void;
  errors?: Record<string, string>;
}

export const GalleryCTASectionForm = ({
  formData,
  handleInputChange,
  errors = {}
}: GalleryCTASectionFormProps) => {
  ...
  if (cardsArray.length === 0) {
    if (formData.card1Title || formData.card2Title || formData.card3Title) {
