...
interface CapitalStatsSectionFormProps {
  formData: any;
  handleInputChange: (key: string, value: any) => void;
  errors?: Record<string, string>;
}

export const CapitalStatsSectionForm = ({
  formData,
  handleInputChange,
  errors = {}
}: CapitalStatsSectionFormProps) => {
  ...
  const addStat = () => {
    handleInputChange('stats', [...stats, { value: '', label: '' }]);
  };
    ...
    <div className="space-y-4">
      <div className="border-2 border-gray-200 rounded-lg p-4 bg-gray-50">
        <div className="flex justify-between items-center mb-4">
          <h4 className="font-semibold text-gray-900">Capital Statistics</h4>
          <button
            type="button"
            onClick={addStat}
        ...
        <div className="space-y-3">
          {stats.length > 0 ? (
            ...
            <p className="text-gray-400 text-sm italic">
              No stats added yet. Click "Add Stat" to add Capital statistics.
            </p>
          )}
        </div>
      </div>
